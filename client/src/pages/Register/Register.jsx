...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!validation.success) {
      return setError(validation.error.issues[0]?.message || "Datos inválidos");
    }
  ...
  return (
    <AuthLayout title={<span>Únete a <span className="gradient-text">GoodHabit</span></span>} subtitle="Empieza a construir una mejor versión de ti mismo hoy.">
      <GoogleButton onClick={handleGoogleRegister} text="Registrarse con Google" />
      ...
      <form className="auth-form" onSubmit={handleSubmit}>
        <div className="form-group">
          ...
          <input type="text" name="name" placeholder="Juan Pérez" value={formData.name} onChange={handleChange} required />
        </div>
        <div className="form-group">
